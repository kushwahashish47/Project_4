		...
		<center>
			...
			<table>
				<tr>
					...
					<td><input type="text" name="login" size="30" placeholder="Enter Login ID" value="<%=DataUtility.getStringData(bean.getLogIn())%>"></td>
				...
				<tr>
					...
					<td><input type="password" name="password" size="30" placeholder="Enter Password" value="<%=DataUtility.getStringData(bean.getPassword())%>"></td>
				...
				<tr>
					<th></th>
					<td><a href="<%=ORSView.FORGET_PASSWORD_CTL%>"><b>Forget my password1</b></a>&nbsp;</td>
				</tr>
			</table>
		</center>
	</form>
